...
export class createUserCustomer1657820480760 implements MigrationInterface {
    name = 'createUserCustomer1657820480760'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "user" (
                ...
                "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
                "customerId" integer,
                CONSTRAINT "REL_6c687a8fa35b0ae35ce766b56c" UNIQUE ("customerId"),
